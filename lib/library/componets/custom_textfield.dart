...
class CustomTextField extends StatelessWidget {
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          filled: true,
          fillColor: isOutlined! ? Colors.transparent : cTextFieldColor,
        ),
      ),
    );
  }
  ...
  OutlineInputBorder _outlineInputBorder() {
    return OutlineInputBorder(
      ...
      borderSide:
          isOutlined! ? const BorderSide(color: cTextColor) : BorderSide.none,
    );
  }
  ...
  TextStyle _textStyleSecondText() {
    return TextStyle(
      height: 4,
      color: isOutlined! ? cTextColor : cSecondryColor,
    );
  }
